...
- `Activation` 不是平行生态对象，而是运行时内部机制：决定当前任务实际注入哪些 tools、instructions 和 skill context。
...
| 维度五：生态扩展 | skills、plugins、MCP、runtime activation、knowledge sources、evidence services |
