...
class ProviderToolSpec:
    ...
    def to_dict(self) -> dict[str, Any]:
        """Return the provider-facing tool schema shape."""
        return {
            "name": self.name,
...
class CompletionParams:
    ...
    def tool_dicts(self) -> list[dict[str, Any]]:
        """Return tools as provider-facing schema dictionaries."""
...
class LLMProvider:
    ...
    async def _complete_request(self, request: CompletionRequest) -> CompletionResponse:
        ...
        _ = request
        raise NotImplementedError("provider must implement _complete_request()")
    ...
    async def complete_request(self, request: CompletionRequest) -> CompletionResponse:
        ...
        Providers implement ``_complete_request`` as the single subclass hook.
        """
