...
### v0.2.1 - 2025-12-22 - 极简主义重构

**核心理念**：少即是多 (Less is More)

- 🎯 **文档精简**：删除 18,000+ 行冗余文档，聚焦核心用法
- 🔧 **代码简化**：
  - `loom/__init__.py`: 400 行 → 45 行（AI 友好的结构）
  - `loom/core/message.py`: 精简 900+ 行复杂度
  - `loom/patterns/crew.py`: 精简 1,200+ 行，聚焦核心功能
- ✨ **哲学转变**：移除不必要的抽象，提升可维护性和可理解性
- 🤖 **AI 优化**：简化的结构更易于 AI Agent 理解和使用

### v0.2.0 - 2025-12-20 - 并发修复 & 可视化

- 🚀 **Loom Studio**：完整的可视化开发平台
- 🔌 **原生 MCP 支持**：Model Context Protocol 集成
- 🛡️ **并发安全**：重构 AgentExecutor，支持线程安全的并行执行

### v0.1.9 - 2024-12-15 - 架构清理 & 记忆优化

- ✅ Message 架构修复（类型安全、数据完整性）
- ✅ Memory 系统优化（智能晋升、异步向量化）
- ✅ 完整测试覆盖（65 个测试全部通过）
