...
class TestCapabilityRegistry:
    ...
    def test_find_relevant_capabilities_no_components(self):
        """Test find_relevant_capabilities with no components"""
        registry = CapabilityRegistry()
        result = registry.find_relevant_capabilities("test task")
    ...
    def test_find_relevant_capabilities_with_tools(self):
    ...
    def test_find_relevant_capabilities_with_skills(self):
        """Test find_relevant_capabilities with skills"""
        # Mock skill registry
        skill_registry = Mock()
        skill_registry.list_skills.return_value = ["skill1", "skill2"]
        ...
        skill_registry.list_skills.assert_called_once()

    def test_find_relevant_capabilities_with_both(self):
        ...
        # Mock skill registry
        skill_registry = Mock()
        skill_registry.list_skills.return_value = ["skill1"]
    ...
    def test_find_relevant_capabilities_tool_manager_exception(self):
        ...
        # Should return empty tools list on exception
        assert len(result.tools) == 0

    def test_find_relevant_capabilities_skill_registry_exception(self):
        """Test find_relevant_capabilities when skill registry raises exception"""
        skill_registry = Mock()
        skill_registry.list_skills.side_effect = Exception("Skill error")

        registry = CapabilityRegistry(skill_registry=skill_registry)
        result = registry.find_relevant_capabilities("test task")

        # Should return empty skill_ids list on exception
        assert len(result.skill_ids) == 0

    def test_validate_skill_dependencies_no_skill_registry(self):
        """Test validate_skill_dependencies with no skill registry"""
        registry = CapabilityRegistry()
        result = registry.validate_skill_dependencies("test_skill")

        assert not result.is_valid
        assert "SkillRegistry not available" in result.error

    def test_validate_skill_dependencies_skill_not_found(self):
    ...
    def test_validate_skill_dependencies_no_required_tools(self):
    ...
    def test_validate_skill_dependencies_all_tools_available(self):
    ...
    def test_validate_skill_dependencies_missing_tools(self):
    ...
    def test_validate_skill_dependencies_no_tool_manager(self):
    ...
    def test_validate_skill_dependencies_get_skill_exception(self):
        """Test validate_skill_dependencies when get_skill raises exception"""
        skill_registry = Mock()
        skill_registry.get_skill.side_effect = Exception("Database error")
    ...
    def test_validate_skill_dependencies_list_tools_exception(self):
