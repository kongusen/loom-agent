...
class TestSkillDefinition:
    ...
    def test_skill_definition_init_minimal(self):
        ...
        assert skill.activation_criteria == ""
    ...
    def test_skill_definition_init_full(self):
        ...
        skill = SkillDefinition(
            ...
            description="A test skill",
            instructions="Do something",
            activation_criteria="When user asks for test",
        ...
        assert skill.activation_criteria == "When user asks for test"
        assert skill.scripts == {"script.py": "print('hello')"}
    ...
    def test_get_full_instructions_full(self):
        ...
        skill = SkillDefinition(
            ...
            description="A test skill",
            instructions="Do something",
            activation_criteria="When user asks",
            scripts={"script.py": "print('hello')"},
            references={"ref.md": "# Reference"},
            required_tools=["tool1", "tool2"],
        )
        ...
        assert "# Skill: Test Skill" in result
        assert "**Activation:** When user asks" in result
    ...
    def test_get_metadata_summary(self):
        ...
        assert result["activation_criteria"] == "When user asks"
